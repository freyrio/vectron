...
│   │   └── bounds.rs # Bounding volumes and rectangles
│   │
│   │
│   ├── units/
│   │   ├── mod.rs            # Unit system exports
│   │   ├── traits.rs         # Core unit traits and conversion interfaces
│   │   ├── types.rs          # Unit type definitions and enums
│   │   ├── logical.rs        # Logical units (em, rem, vh, vw, %)
│   │   ├── physical.rs       # Physical units (px, pt, in, cm, mm)
│   │   ├── computed.rs       # Computed/derived units
│   │   ├── context.rs        # Unit resolution context
│   │   ├── conversion.rs     # Unit conversion utilities
│   │   └── math.rs           # Mathematical operations on units
│   │
│   ├── color/
│   │   ├── mod.rs            # Color system exports
│   │   ├── types.rs          # Base color type definitions
│   │   ├── spaces/           # Color space implementations
│   │   │   ├── mod.rs        # Color spaces exports
│   │   │   ├── rgb.rs        # RGB color space (sRGB, linear RGB, etc.)
│   │   │   ├── cmyk.rs       # CMYK color space for print
│   │   │   ├── hsv.rs        # HSV/HSB color space
│   │   │   ├── hsl.rs        # HSL color space
│   │   │   ├── lab.rs        # LAB color space
│   │   │   ├── xyz.rs        # XYZ color space
│   │   │   └── lch.rs        # LCH color space
│   │   │
│   │   ├── conversion.rs     # Color space conversion
│   │   ├── palette.rs        # Color palette management
│   │   ├── gradient.rs       # Gradient definitions and interpolation
│   │   ├── blend.rs          # Blending modes and operations
│   │   ├── icc.rs            # ICC profile support
│   │   └── named.rs          # Named color constants
│   │
│   │
│   ├── style/      # Style system
│   │   ├── mod.rs  # Style module exports
│   │   ├── traits.rs # Style traits
│   │   ├── fill.rs # Fill style implementation
│   │   ├── stroke.rs # Stroke style implementation
│   │   └── paint.rs # Paint implementations (solid, gradient, etc.)
│   │
│   ├── effect/     # Effect system
│   │   ├── mod.rs  # Effect module exports
│   │   ├── traits.rs # Effect traits
│   │   ├── shadow.rs # Shadow effect implementation
│   │   └── blur.rs # Blur effect implementation
│   │
│   ├── tessellation/ # Tessellation system
│   │   ├── mod.rs  # Tessellation module exports
│   │   ├── traits.rs # Tessellable trait definition
│   │   ├── options.rs # TessellationOptions and related types
│   │   ├── result.rs # TessellationResult and data structures
│   │   ├── path.rs # Path tessellation utilities
│   │   └── mesh.rs # Mesh tessellation utilities
│   │
│   ├── rasterization/ # Rasterization system (new!)
│   │   ├── mod.rs  # Rasterization module exports
│   │   ├── traits.rs # Rasterizable trait definition
│   │   ├── buffer.rs # PixelBuffer and related types
│   │   ├── options.rs # RasterizationOptions
│   │   ├── result.rs # RasterizationData and related types
...
## 3. Matrix Structure and Coordinate System
...
// Position types (semantically different from vectors)
pub struct Point2D(pub f32, pub f32);
pub struct Point3D(pub f32, pub f32, pub f32);

// Conversion between 2D and 3D coordinates
impl Point2D {
    pub fn to_3d(&self, z: f32) -> Point3D {
        Point3D(self.0, self.1, z)
    }
}
